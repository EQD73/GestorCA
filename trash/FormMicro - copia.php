            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 mt-2">
                        ...
                        <select class="form-select form-select-sm" id="CodigoCurso" name="CodigoCurso" autofocus>
                            ...
                            while ($obj = pg_fetch_object($resultado_qa)) { ?>
                                <option value="" data-codigo="<?php echo $obj->codigo_asignatura; ?>" data-nombre="<?php echo $obj->nom_asignatura; ?>" data-grupo="<?php echo $obj->grupo; ?>"><?php echo $codcurso = $obj->codigo_asignatura;
                                                                                        echo "  |  ";
                    ...
                    <div class="col-md-3 mt-2">
                        ...
                        <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="CodigoFacultad" id="CodigoFacultad">
                            ...
                            while ($obj = pg_fetch_object($resultado_qf)) { ?>
                                <option value="" data-codigo="<?php echo $obj->codigo_facultad; ?>" data-nombre="<?php echo $obj->nombre_facultad; ?>"><?php echo $codfac = $obj->codigo_facultad;
                                                                                        echo "  |  ";
                ...
                <div class="row">  
                    ...
                    <div class="col-md-3 mt-2">
                        ...
                        <select class="form-select form-select-sm" aria-label=".form-select-sm example" id="CodigoPrograma" name="CodigoPrograma">
                            ...
                            while ($obj = pg_fetch_object($resultado_qp)) { ?>
                                <option value="" data-codigo="<?php echo $obj->codigo_programa; ?>" data-nombre="<?php echo $obj->nombre_programa; ?>"><?php echo $obj->codigo_programa;
                                                                                        echo "  |  ";
                    ...
                    <div class="col-md-3 mt-2">
                        ...
                        <input type="text" class="form-control form-control sm" id="creditos" name="creditos" placeholder="ingrese Créditos">
                    </div>
                </div>
                <div class="row">   
                    <div class="col-md-3 mt-2">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 mt-2">
                        ...
                        <textarea class="form-control" id="AsignaturaProy" name="AsignaturaProy" placeholder="ingresar Asignaturas del proyecto" rows="2"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <label for="formGroup" class="form-label">Temáticas de investigación a desarrollar en el proyecto integrador</label>
                        <textarea class="form-control" id="TematicasProy" name="TematicasProy" placeholder="ingresar Tematicas del proyecto" rows="2"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <label for="formGroup" class="form-label">Acciones por realizar en el proyecto integrador</label>
                        <textarea class="form-control" id="AccionesProy" name="AccionesProy" placeholder="ingresar Acciones del proyecto" rows="2"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mt-2"></div>
