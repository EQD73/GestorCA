...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                <div class="row">
                    <h4 class="text-center">Periodo Académico: <?php echo $_SESSION['codigo_periodo']; echo " "; echo $_SESSION['nombre_periodo'] ;?></h4>
                 
                </div>
                <div class="container mt-3 p-3">
                    <div class="row">
                        <h4 class="text-center">Módulo MicroCurriculo - Informes/Reportes</h4>
                        <hr>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            ...
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modal-impmicro">
                                Generar Reporte Registro de Actividades
                            </button></div>
                            <?php include("Modal_ImpRegistro.php"); ?>
                        </div>
                       <!--  <div class="col-md-4">
                ...
                <div class="row" id="form-visible" style="display:none">
    ...
    <script type="text/javascript">
            ...
            /* Referencia a los in*/
            var elCode = document.getElementById('CodCur');
    ...
    <script type="text/javascript">
       // Accedemos al botón
        var CodigoConsultaCursoSelect = document.getElementById('CodigoConsultaCurso');
        var GrupoInput = document.getElementById('grupo');
       // evento para el input radio de uno
        document.getElementById('flexRadioOp1').addEventListener('click', function(e) {
        //console.log('Vamos a habilitar el input text');
        CodigoConsultaCursoSelect.readonly = false;
        GrupoInput.readonly = false;
        });

        // evento para el input radio de todas
        document.getElementById('flexRadioOp2').addEventListener('click', function(e) {
        //console.log('Vamos a deshabilitar el input text');
        CodigoConsultaCursoSelect.readonly = true;
