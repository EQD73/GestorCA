                    ...
                    <div class="col-4 offset-9">
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-primary btn-xs" data-bs-toggle="modal" data-bs-target="#modalUsuario" style="font-size:0.8em" id="botonCrear">
                                <i class="fa fa-user-plus" aria-hidden="true"></i> Nueva Consignación</button>
                        </div>
                    </div>
                </div>
                <br />
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.editar', function() {
               ...
               var id_consigna = $(this).attr("id");
                ...
                $.ajax({
                    url: "obtener_registroConsigna.php",
                    method: "POST",
                    data: {
                ...
                window.location.href="consultar_consignador.php"; 
            });
            ...
            $(document).on('click', '.imprimir', function() {
               ...
               // alert(id_micro);
                ...
                window.open("imprimirConsignador.php"); 
            });
