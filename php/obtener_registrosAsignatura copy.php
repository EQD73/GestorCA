...
$searchQueryVal[] = 0;
if ($searchValue != '') {
   $searchQuery .= " and (codigo_asignatura ilike $2 or nom_asignatura ilike $3 or codigo_docente ilike $4 or nombre_docente ilike $5)";
...
## Fetch records
$sql = "select a.*, p.nombre_programa FROM sistema.asignaturas a INNER JOIN sistema.programas p  ON a.codigo_programa = p.codigo_programa WHERE " . $searchQuery . " AND a.periodo='$periodo' order by " . $columnName . " " . $columnSortOrder . " limit $rowperpage OFFSET $row";
