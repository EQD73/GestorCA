...
if ($obj->codigo_programa <> "26" && $obj->codigo_programa <> "30" && $obj->codigo_programa <> "31" && $obj->codigo_programa <> "32") {
    ...
    $pdf->SetXY(30, $y);
    $pdf->SetFont("Arial", "", 8);
    $pdf->Cell(115, 5, mb_convert_encoding($obj->nombre_programa, 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 8);
    $pdf->Cell(35, 5, mb_convert_encoding("Periodo Académico:", 'ISO-8859-1'), 0, 0, "L");
    $pdf->SetFont("Arial", "", 8);
    $pdf->Cell(15, 5, mb_convert_encoding($obj->codigo_periodo, 'ISO-8859-1'), 1, 1, "C");
    $pdf->Cell(200, 1, "", 0, 1);
    $pdf->SetFont("Arial", "B", 8);
    ...
    $pdf->SetXY(30, $y);
    $pdf->SetFont("Arial", "", 8);
    $pdf->Cell(15, 5, mb_convert_encoding($obj->codigo_asignatura, 'ISO-8859-1'), 1, 0, "C");
    $pdf->Cell(110, 5, mb_convert_encoding($obj->nombre_asignatura, 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 8);
    $pdf->Cell(12, 5, mb_convert_encoding("Grupo:", 'ISO-8859-1'), 0, 0, "L");
    $pdf->SetFont("Arial", "", 8);
    $pdf->Cell(5, 5, mb_convert_encoding($obj->grupo, 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 8);
    $pdf->Cell(10, 5, mb_convert_encoding("Sem:", 'ISO-8859-1'), 0, 0, "L");
    $pdf->SetFont("Arial", "", 8);
    $pdf->Cell(5, 5, mb_convert_encoding($obj->semestre, 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 8);
    $pdf->Cell(15, 5, mb_convert_encoding("H.T.T.S:", 'ISO-8859-1'), 0, 0, "L");
    $pdf->SetFont("Arial", "", 8);
    $pdf->Cell(5, 5, mb_convert_encoding($obj->htts, 'ISO-8859-1'), 1, 1, "C");
    $pdf->Cell(200, 1, "", 0, 1);
    $pdf->SetFont("Arial", "B", 8);
