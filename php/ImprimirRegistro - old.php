...
//taer id para filtrar el registro
...
$codigoConsulta = $obj_temporal->valor4;
...
$pdf->Cell(173);
$pdf->Cell(14, 4, mb_convert_encoding("FECHA",'ISO-8859-1'), 0, 0, "C");
$pdf->Cell(14, 4, mb_convert_encoding("TIPO",'ISO-8859-1'), 0, 0, "C");
...
$pdf->Cell(13, 5, mb_convert_encoding("FEC.REG",'ISO-8859-1'), 0, 0, "L");
$pdf->Cell(13, 5, mb_convert_encoding("HOR.REG",'ISO-8859-1'), 0, 0, "L");
$pdf->SetXY(103,$y);
$pdf->MultiCell(15, 3, mb_convert_encoding("TIPO \n"."ACT.",'ISO-8859-1'), 0, "C",0);
$pdf->SetXY(110,$y);
$pdf->MultiCell(50, 3, mb_convert_encoding("DESCRIPCION \n"."ACT.",'ISO-8859-1'), 0, "C",0);
$pdf->SetXY(165,$y);
$pdf->Cell(20, 5, mb_convert_encoding("JUSTIFICACION",'ISO-8859-1'), 0, 0, "L");
$pdf->Cell(15, 4, mb_convert_encoding("NOVEDAD",'ISO-8859-1'), 0, 0, "L");
$pdf->Cell(15, 4, mb_convert_encoding("NOVEDAD",'ISO-8859-1'), 0, 0, "L");
$pdf->SetFont("Arial", "B", 6);
$pdf->SetXY(217,$y);
$pdf->MultiCell(20, 3, mb_convert_encoding("FECHA \n"."INICIO",'ISO-8859-1'), 0,"C",0);
$pdf->SetXY(227,$y);
$pdf->MultiCell(20, 3, mb_convert_encoding("FECHA \n"."FINAL",'ISO-8859-1'), 0, "C", 0);
$pdf->SetFont("Arial", "B", 7);
$pdf->SetXY(247,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s1_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s1_fechareproginicial==" " || $obj->s1_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s1_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s1_fechareprogfinal==" " || $obj->s1_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s1_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s2_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s2_fechareproginicial==" " || $obj->s2_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s2_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s2_fechareprogfinal==" " || $obj->s2_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s2_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s3_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s3_fechareproginicial==" " || $obj->s3_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s3_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s3_fechareprogfinal==" " || $obj->s3_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s3_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s4_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s4_fechareproginicial==" " || $obj->s4_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s4_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s4_fechareprogfinal==" " || $obj->s4_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s4_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s5_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s5_fechareproginicial==" " || $obj->s5_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s5_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s5_fechareprogfinal==" " || $obj->s5_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s5_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s6_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s6_fechareproginicial==" " || $obj->s6_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s6_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s6_fechareprogfinal==" " || $obj->s6_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s6_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s7_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s7_fechareproginicial==" " || $obj->s7_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s7_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s7_fechareprogfinal==" " || $obj->s7_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s7_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s8_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s8_fechareproginicial==" " || $obj->s8_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s8_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s8_fechareprogfinal==" " || $obj->s8_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s8_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s9_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s9_fechareproginicial==" " || $obj->s9_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s9_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s9_fechareprogfinal==" " || $obj->s9_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s9_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s10_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s10_fechareproginicial==" " || $obj->s10_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s10_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s10_fechareprogfinal==" " || $obj->s10_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s10_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s11_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s11_fechareproginicial==" " || $obj->s11_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s11_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s11_fechareprogfinal==" " || $obj->s11_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s11_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s12_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s12_fechareproginicial==" " || $obj->s12_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s12_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s12_fechareprogfinal==" " || $obj->s12_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s12_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s13_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s13_fechareproginicial==" " || $obj->s13_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s13_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s13_fechareprogfinal==" " || $obj->s13_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s13_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s14_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s14_fechareproginicial==" " || $obj->s14_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s14_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s14_fechareprogfinal==" " || $obj->s14_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s14_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s15_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s15_fechareproginicial==" " || $obj->s15_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s15_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s15_fechareprogfinal==" " || $obj->s15_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s15_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->SetXY(165,$y);
$pdf->MultiCell(20, 2, mb_convert_encoding($obj->s16_justifica_nov, 'ISO-8859-1'), 0,'J',0,4);
$pdf->SetXY(185,$y);
...
$pdf->SetXY(220,$y);
if ($obj->s16_fechareproginicial==" " || $obj->s16_fechareproginicial==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{   
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s16_fechareproginicial)), 0, 0, "L"); 
}
$pdf->SetXY(232,$y);
if ($obj->s16_fechareprogfinal==" " || $obj->s16_fechareprogfinal==null){
    $pdf->Cell(10, 6, " ", 0, 0, "L");
}else{    
    $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s16_fechareprogfinal)), 0, 0, "L");
}    
$pdf->SetXY(245,$y);
...
$pdf->Cell(0,5, mb_convert_encoding('Página ', 'ISO-8859-1').$pdf->PageNo().'/ {nb}',0, 0, "R"); 
    ...
    $pdf->SetXY(165,$y);
    $pdf->MultiCell(20, 2, mb_convert_encoding($obj->s1_justifica_nov_p, 'ISO-8859-1'), 0,'J',0,4);
    $pdf->SetXY(185,$y);
    ...
    $pdf->SetXY(220,$y);
    if ($obj->s1_fechareproginicial_p==" " || $obj->s1_fechareproginicial_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{   
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s1_fechareproginicial_p)), 0, 0, "L"); 
    }
    $pdf->SetXY(232,$y);
    if ($obj->s1_fechareprogfinal_p==" " || $obj->s1_fechareprogfinal_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{    
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s1_fechareprogfinal_p)), 0, 0, "L");
    }    
    $pdf->SetXY(245,$y);
    ...
    $pdf->SetXY(165,$y);
    $pdf->MultiCell(20, 2, mb_convert_encoding($obj->s2_justifica_nov_p, 'ISO-8859-1'), 0,'J',0,4);
    $pdf->SetXY(185,$y);
    ...
    $pdf->SetXY(220,$y);
    if ($obj->s2_fechareproginicial_p==" " || $obj->s2_fechareproginicial_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{   
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s2_fechareproginicial_p)), 0, 0, "L"); 
    }
    $pdf->SetXY(232,$y);
    if ($obj->s2_fechareprogfinal_p==" " || $obj->s2_fechareprogfinal_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{    
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s2_fechareprogfinal_p)), 0, 0, "L");
    }    
    $pdf->SetXY(245,$y);
    ...
    $pdf->SetXY(165,$y);
    $pdf->MultiCell(20, 2, mb_convert_encoding($obj->s3_justifica_nov_p, 'ISO-8859-1'), 0,'J',0,4);
    $pdf->SetXY(185,$y);
    ...
    $pdf->SetXY(220,$y);
    if ($obj->s3_fechareproginicial_p==" " || $obj->s3_fechareproginicial_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{   
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s3_fechareproginicial_p)), 0, 0, "L"); 
    }
    $pdf->SetXY(232,$y);
    if ($obj->s3_fechareprogfinal_p==" " || $obj->s3_fechareprogfinal_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{    
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s3_fechareprogfinal_p)), 0, 0, "L");
    }    
    $pdf->SetXY(245,$y);
    ...
    $pdf->SetXY(165,$y);
    $pdf->MultiCell(20, 2, mb_convert_encoding($obj->s4_justifica_nov_p, 'ISO-8859-1'), 0,'J',0,4);
    $pdf->SetXY(185,$y);
    ...
    $pdf->SetXY(220,$y);
    if ($obj->s4_fechareproginicial_p==" " || $obj->s4_fechareproginicial_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{   
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s4_fechareproginicial_p)), 0, 0, "L"); 
    }
    $pdf->SetXY(232,$y);
    if ($obj->s4_fechareprogfinal_p==" " || $obj->s4_fechareprogfinal_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{    
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s4_fechareprogfinal_p)), 0, 0, "L");
    }    
    $pdf->SetXY(245,$y);
    ...
    $pdf->SetXY(165,$y);
    $pdf->MultiCell(20, 2, mb_convert_encoding($obj->s5_justifica_nov_p, 'ISO-8859-1'), 0,'J',0,4);
    $pdf->SetXY(185,$y);
    ...
    $pdf->SetXY(220,$y);
    if ($obj->s5_fechareproginicial_p==" " || $obj->s5_fechareproginicial_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{   
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s5_fechareproginicial_p)), 0, 0, "L"); 
    }
    $pdf->SetXY(232,$y);
    if ($obj->s5_fechareprogfinal_p==" " || $obj->s5_fechareprogfinal_p==null){
        $pdf->Cell(10, 6, " ", 0, 0, "L");
    }else{    
        $pdf->Cell(10, 6, date("d-m-Y",strtotime($obj->s5_fechareprogfinal_p)), 0, 0, "L");
    }    
    $pdf->SetXY(245,$y);
