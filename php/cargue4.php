...
?>
        ...
        <div id="app">
            ...
            <div id="main">
                ...
                <div class="container mt-5">
                    <h3 class="text-center">Carga Masiva de la tabla Pensum Académico</h3>

                    <!-- Enlace de descarga con una imagen -->
                    <div class="text-center">
                        <a href="descargar4.php" class="btn btn-danger">
                            ...
                            Descargar Plantilla Pensum.CSV
                        </a>
                    </div>
                    ...
                    <div class="card mt-3">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Tabla de Pensum</h5>
                            <button id="infoProgramasBtn" class="btn btn-outline-danger btn-sm">
                                <i class="bi bi-question-circle me-1"></i> Códigos de programas
                            </button>
                            <button id="infoFacultadesBtn" class="btn btn-outline-info btn-sm">
                                <i class="bi bi-question-circle me-1"></i> Códigos de facultades
                            </button>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#infoFacultadesBtn').on('click', function() {
                Swal.fire({
                    title: 'Recuerda:',
                    icon: 'info',
                    html: `
                     <ul class="text-start mb-0" style="max-height: 300px; overflow-y: auto;">
                        <li><strong>Codigo facultad = 1</strong> → FACULTAD DE CIENCIAS DE LA SALUD</li>
                        <li><strong>Codigo facultad = 2</strong> → FACULTAD DE CIENCIAS EMPRESARIALES, ECONOMICAS Y AFINES</li>
                        <li><strong>Codigo facultad = 3</strong> → FACULTAD DE INGENIERIA</li>                        
                    </ul>
                `,
                    confirmButtonText: 'Cerrar',
                    width: 'auto',
        ...
        document.getElementById('csvFile').addEventListener('change', function(e) {
            ...
            reader.onload = function(e) {
                try {
                    ...
                    const headerWords = ['programa', 'facultad', 'asignatura', 'nom_asignatura', 'semestre', 'estado'];
        ...
        function renderPreview(data) {
            ...
            if (Array.isArray(data) && data.length > 0) {
                data.forEach(function(row) {
                    tbody.append(
                        '<tr>' +
                        '<td>' + row.codigoprog + '</td>' +
                        '<td>' + row.codigofacul + '</td>' +
                        '<td>' + row.codigoasig + '</td>' +
                        '<td>' + row.nom_asignatura + '</td>' +
                        '<td>' + row.semestre + '</td>' +
                        '<td>' + row.estado + '</td>' +
                        '</tr>'
                    );
