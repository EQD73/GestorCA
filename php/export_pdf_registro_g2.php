...
class PDF extends FPDF
{
  ...
  function Header()
  {
    ...
    $this->Cell(200, 14, mb_convert_encoding("REGISTRO DE ACTIVIDADES / GRAFICO AVANCE POR DOCENTE", 'ISO-8859-1'), 0, 1, "C");
...
if (file_exists("../images/graficos/graficor2.png")) {
  ...
  $pdf->Image("../images/graficos/graficor2.png", $grafico_x, $grafico_y_inicial, $grafico_ancho);
...
$pdf->Cell(25, 10, mb_convert_encoding("F. Registro...", 'ISO-8859-1'), 1, 0, "L");
$pdf->Ln();
...
FROM sistema.m3 m3
WHERE m3.codigo_docente = '$docente'
  AND m3.codigo_periodo = '$periodo'";
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
  ...
  $pdf->Cell(25, 10, $row['fecha_registro'], 1);
  $pdf->Ln();
}

$pdf->Output("I", "reporte_avance_r.pdf");
