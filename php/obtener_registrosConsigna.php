...
if ($codigo_rol=='4'){ 
  $sql = "SELECT * FROM $tablam2 WHERE codigo_periodo='$codperiodo' AND codigo_programa='$objp->codigo_programa'";
}

## Fetch records
if ($codigo_rol=='1' || $codigo_rol=='5'){
   $sql = "SELECT * FROM $tablam2 WHERE codigo_periodo='$codperiodo'";   
}else if ($codigo_rol=='2'){   
$sql = "SELECT * FROM $tablam2 WHERE codigo_docente=$codigo_usuario::varchar AND codigo_periodo='$codperiodo'";
}
