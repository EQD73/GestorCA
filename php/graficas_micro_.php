    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="container-fluid mt-4 mx-auto">
                ...
                <!-- Gráfica -->
                <div class="card-fluid mt-4 mx-auto">
                    <div class="card-body">
                        <canvas id="graficoDocentes" width="1500" height="900"></canvas>
                    </div>
                </div>
            </div>
                ...
                function cargarDatos() {
                    ...
                    fetch(url)
                        ...
                        .then(data => {
                            ...
                            chart = new Chart(document.getElementById("graficoDocentes"), {
                                type: 'bar',
                                data: {
                                    labels: nombres, // nombres de docentes
                                    datasets: [{
                                ...
                                options: {
                                    ...
                                    plugins: {
                                        ...
                                        title: {
                                            display: true,
                                            text: 'Unidades diligenciadas por docente'
                                        }
                                    },
                                    scales: {
                                        x: {
