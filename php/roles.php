...
$query_roles = "SELECT * FROM sistema.roles ORDER BY codigo_rol ASC ";
$resultado_qrol = pg_query($conexion, $query_roles);
$num1 = pg_num_rows($resultado_qrol);
?>
...
?>
    ...
    <body>
        ...
        $pageTitle = "Gestión Control de Usuarios"; // Cambia esto según la lógica de tu aplicación style="font-size:0.8em"
        include("topbar.html"); ?>
        <!-- <div class="container mt-5 pt-3" style="margin-left: var(--sidebar-width); max-width:87%;"> -->
        <main id="content">
            <h4 class="text-center mt-2">CRUD Tabla de Roles de Usuarios</h4>


            <div class="row text-center" style="background-color: #cecece">
                <div class="col-md-6">
                    <strong>Registrar Nuevo Rol</strong>
                </div>
                <div class="col-md-6">
                    <strong>Lista de Roles <span style="color: crimson"> ( <?php echo $num1; ?> )</span> </strong>
                </div>
            </div>
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="color:black" style="width:50px" scope="col">Estado</th>
                                                        <th style="color:black" style="width:80px" scope="col">Acción</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    while ($dataRol = pg_fetch_array($resultado_qrol)) { ?>
                                                        <tr>
                                                            <td><?php echo $dataRol['codigo_rol']; ?></td>
                                                            <td><?php echo $dataRol['nombre_rol']; ?></td>
                                                            <td><?php echo $dataRol['estado']; ?></td>


                                                            <td>
                                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteChildresn<?php echo $dataRol['codigo_rol']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">
                                                                    <i data-feather="trash-2" width="20"></i>
                                                                </button>

                                                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editChildresn<?php echo $dataRol['codigo_rol']; ?>" data-toggle="tooltip" data-placement="top" title="Modificar">
                                                        ...
                                                        <?php include('ModalEditarRol.php'); ?>

                                                        <!--Ventana Modal para la Alerta de Eliminar--->
                                                        <?php include('ModalEliminarRol.php'); ?>
