            ...
            <div class="main-content container-fluid">
                ...
                <div class="row">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <a href="editar_novedadRegistro.php" class="btn btn-info btn-ms" id="BtnAgregar" type="button" data-toggle="tooltip" data-placement="top" title="Agregar Registro de Actividades"><i data-feather="file-plus" width="20"></i> Agregar</a>
                        <a href="modificar_novedadRegistro.php" class="btn btn-warning btn-ms" id="BtnEditar" type="button" data-toggle="tooltip" data-placement="top" title="Editar Registro de Actividades"><i data-feather="edit" width="20"></i> Editar</a>
    ...
    <script type="text/javascript">
        function mostraropt3() {
            ...
            $.ajax({
                ...
                .done(function(data) {
                    //alert(data);
                    $('#pills-2cont').load('FormsRegularRegistro.php');
                });
