...
<body>
    ...
    $pageTitle = "Gestión de Informes"; // Cambia esto según la lógica de tu aplicación style="font-size:0.8em"
    include("topbar.html"); ?>
    <!-- <div class="container mt-5 pt-3" style="margin-left: var(--sidebar-width); max-width:87%;"> -->
    <main id="content">
        <h3 class="text-center">Reporte de Registros de Actividades</h3>
        <?php
        ...
        <div class="container mt-4">
            ...
            <div class="d-flex justify-content-center mt-3 gap-2">
                <form method="GET" target="_blank" action="generar_pdf_rregistro.php">
    ...
    <script>
        $(document).ready(function() {
            function cargarAsignaturas() {
                ...
                $.ajax({
                    url: "get_asignaturas_rregistro.php",
                    type: "POST",
                    data: {
