...
## Fetch records
$sql = "SELECT u.*, r.nombre_rol FROM sistema.usuarios u JOIN sistema.roles r ON u.codigo_rol = r.codigo_rol WHERE " . $searchQuery . " order by " . $columnName . " " . $columnSortOrder . " limit $rowperpage OFFSET $row";
