...
?>
    ...
    <body>
        ...
        <main id="content">
            <h4 class="text-center">CRUD - Tabla de Facultades</h4>
            <div class="row text-center" style="background-color: #cecece">
                <div class="col-md-6">
                    <strong>Registrar Nueva Facultad</strong>
                </div>
                <div class="col-md-6">
                    <strong>Lista de Facultades <span style="color: crimson"> ( <?php echo $num1; ?> )</span> </strong>
                </div>
            </div>
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-5">
                                ...
                                <?php include('GuardarFacultades.php');  ?>
                            </div>
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-md-12 p-2">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <?php
                                                    while ($dataFacultad = pg_fetch_array($resultado_qf)) { ?>
                                                        <tr>
                                                            <td><?php echo $dataFacultad['codigo_facultad']; ?></td>
                                                            <td><?php echo $dataFacultad['nombre_facultad']; ?></td>
                                                            <td><?php echo $dataFacultad['estado']; ?></td>


                                                            <td>
                                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteChildresn<?php echo $dataFacultad['codigo_facultad']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">
                                                                    <i data-feather="trash-2" width="20"></i>
                                                                </button>

                                                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editChildresn<?php echo $dataFacultad['codigo_facultad']; ?>" data-toggle="tooltip" data-placement="top" title="Modificar">
                                                                    <i data-feather="edit" width="20"></i>
                                                                </button>
                                                            </td>
                                                        </tr>
                                                        <!--Ventana Modal para Actualizar--->
                                                        <?php include('ModalEditarFacultades.php'); ?>
                                                        <!--Ventana Modal para la Alerta de Eliminar--->
                                                        <?php include('ModalEliminarFacultades.php'); ?>
                                                    <?php } ?>
                                            </table>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.btnBorrar').click(function(e) {
                ...
                url = "recib_DeleteFacultades.php";
                $.ajax({
                    type: "POST",
                    url: url,
                    data: dataString,
                    success: function(data) {
                        window.location.href = "facultades.php";
                        $('#respuesta').html(data);
                    }
                });
                return false;
