        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <div class="container p-3">
                    <h4 class="text-center" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Módulo Registro de Actividades - Editar registro Regular</h4>
                    <hr>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <?php include('FormMRegularRegistro.php'); ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        function mostraropt3() {
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    $('#pills-2cont').load('FormsMRegularRegistro.php?id=' + idrow);
                });
