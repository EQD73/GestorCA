...
//$conexionx=pg_connect("host=localhost port=5434 dbname=postgres user=postgres password=Killa2022 options='--search_path=sistema'");
...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
                    ...
                    <ul class="navbar-nav d-flex align-items-center navbar-light ms-auto">
                        ...
                        <li class="dropdown">
                            <a href="#" data-bs-toggle="dropdown"
                                ...
                                <div class="d-none d-md-block d-lg-inline-block"><?php echo $_SESSION['nombre_rol']; ?>
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <!-- <a class="dropdown-item" href="#"><i data-feather="settings"></i> Settings</a> -->
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="logout.php" onclick="cerrarsession()"><i
                                        data-feather="log-out"></i>Salir</a>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="main-content container-fluid">
                <div class="row">
                    <h4 class="text-center" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Periodo
                        Académico: <?php echo $_SESSION['descripcion']; ?></h4>

                </div>
                <div class="container p-3">
                    <h4 class="text-center" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Módulo
                        Consignador Académico - Editar registro</h4>
                    <hr>
                </div>
                ...
                <ul class="nav nav-pills sm-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-1-tab" data-bs-toggle="pill" data-bs-target="#pills-1"
                            type="button" role="tab" aria-controls="pills-1" aria-selected="true">Información
                            General</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-2-tab" data-bs-toggle="pill" data-bs-target="#pills-2"
                            ...
                            onclick=mostraropt2();>Desarrollo de la asignatura (Semanas)</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-3-tab" data-bs-toggle="pill" data-bs-target="#pills-3"
                            type="button" role="tab" aria-controls="pills-3" aria-selected="false">Validación</button>
                    </li>
                </ul>
                <div class="row">
                    <div class="col-md-12 mt-2">
                        <?php include('FormConsignadorConsulta.php');
                        ?>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        //document.getElementById('CodigoPrograma').onkeyup = function() {
        /* Referencia a los atributos data de la opción seleccionada */
        //var mData = this.options[this.selectedIndex].dataset;

        /*  /* Referencia a los input 
         var elCode = document.getElementById('CodigoPrograma');
        ...
        function mostraropt2() {
            ...
            $.ajax({
                ...
                .done(function(data) {
                    //alert(data);
                    $('#pills-2').load('FormsConsignaConsulta.php');
                });
        ...
        //      /* Referencia a los input 
        //      var elCode2 = document.getElementById('CodigoCur');
        //      var elName2 = document.getElementById('NombreCurso');
        //      var elGroup = document.getElementById('grupo');

        //      /* Asignamos cada dato a su input
        //      elCode2.value = mData.codigo;
        //      elName2.value = mData.nombre;
