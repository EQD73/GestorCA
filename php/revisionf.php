...
//select de tabla VERSION formato
$query_formato = "SELECT * FROM sistema.version_formato ORDER BY codigo_formato ASC ";
$resultado_qformato = pg_query($conexion, $query_formato);
$num1 = pg_num_rows($resultado_qformato);
...
?>
    ...
    <body>
        ...
        <main id="content">
            <h4 class="text-center mt-2">CRUD - Tabla de version formato (reportes)</h4>

            <div class="row text-center" style="background-color: #cecece">
                <div class="col-md-6">
                    <strong>Registrar Nuevo Version Formato</strong>
                </div>
                <div class="col-md-6">
                    <strong>Lista de Version Formato <span style="color: crimson"> ( <?php echo $num1; ?> )</span> </strong>
                </div>
            </div>
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-5">
                                ...
                                <?php include('GuardarFormato.php');  ?>
                                    ...
                                    <div class="col-md-12 p-2">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                        <th style="color:black" style="width:30px" scope="col">Código</th>
                                                        <th style="color:black" style="width:30px" scope="col">Nombre</th>
                                                        <th style="color:black" style="width:50px" scope="col">Cod</th>
                                                        <th style="color:black" style="width:50px" scope="col">Version</th>
                                                        <th style="color:black" style="width:50px" scope="col">Fecha</th>
                                                        <th style="color:black" style="width:80px" scope="col">Acción</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    while ($dataFormato = pg_fetch_array($resultado_qformato)) { ?>
                                                        <tr>
                                                            <td><?php echo $dataFormato['codigo_formato']; ?></td>
                                                            <td><?php echo $dataFormato['nombre_formato']; ?></td>
                                                            <td><?php echo $dataFormato['codigo']; ?></td>
                                                            <td><?php echo $dataFormato['version']; ?></td>
                                                            <td><?php echo $dataFormato['fecha']; ?></td>


                                                            <td>
                                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteChildresn<?php echo $dataFormato['codigo_formato']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">
                                                                    <i data-feather="trash-2" width="20"></i>
                                                                </button>

                                                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editChildresn<?php echo $dataFormato['codigo_formato']; ?>" data-toggle="tooltip" data-placement="top" title="Modificar">
                                                        ...
                                                        <?php include('ModalEditarFormato.php'); ?>

                                                        <!--Ventana Modal para la Alerta de Eliminar--->
                                                        <?php include('ModalEliminarFormato.php'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.btnBorrar').click(function(e) {
                ...
                url = "recib_DeleteFormato.php";
                $.ajax({
                    type: "POST",
                    url: url,
                    data: dataString,
                    success: function(data) {
                        window.location.href = "revisionf.php";
                        $('#respuesta').html(data);
                    }
                });
                return false;
