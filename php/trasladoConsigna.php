...
?>
            ...
            <div id="main">
                ...
                <div class="container mt-5">
                    <div class="card shadow-lg p-4">
                        <h3 class="mb-4 text-center">Traslado entre periodos - Consignador de Actividades</h3>
    ...
    <script>
        document.getElementById("periodo_origen").addEventListener("change", function() {
            ...
            fetch("get_asignaturas_trasladoc.php?periodo=" + periodo)
                .then(res => res.json())
                .then(data => {
    ...
    <script>
        document.getElementById('codigo_usuario').addEventListener('blur', function() {
            ...
            fetch('buscar_usuario_tm2.php?codigo=' + codigo)
