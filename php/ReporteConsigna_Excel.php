    ...
    <script>
        $(document).ready(function() {
            ...
            $("#exportExcel").click(function() {
                ...
                let semestre = $("#selectSemestre").val();
                let grupo = $("#selectGrupo").val();
                window.location.href = "export_excel_consigna_r2.php?periodo=" + periodo + "&programa=" + programa + "&asignatura=" + asignatura + "&semestre=" + semestre + "&grupo=" + grupo; // Redirige a exportar_excel.php
            });
        });
    </script>
