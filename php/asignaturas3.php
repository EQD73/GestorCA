...
<body>
    <div class="container mt-4">
        <h3 class="text-center mb-4">Gestión de Asignaturas</h3>
        <div class="d-flex justify-content-end mb-3">
            <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#asignaturaModal" onclick="resetForm()">
                <i class="bi bi-plus-circle"></i> Nueva Asignatura
            </button>
        </div>


        <table id="asignaturasTable" class="table table-striped table-bordered" style="width:100%">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            // Configurar modal
                            $('#modalAsignaturasHeader').removeClass('bg-primary bg-info').addClass('bg-warning text-gray');
