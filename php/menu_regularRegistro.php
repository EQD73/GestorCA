        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <div class="container p-3">
                    <h4 class="text-center" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Módulo Registro de Actividades - Registro Regular</h4>
                    <hr>
                </div>
                <div class="row">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <?php $url1 = "editar_regularRegistro.php?id=" . urlencode($codigoConsulta); ?>
                        <?php $url2 = "modificar_regularRegistro.php?id=" . urlencode($codigoConsulta); ?>
