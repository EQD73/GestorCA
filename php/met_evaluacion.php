...
//select de tabla metodologia evaluacion

$query_mevalua = "SELECT * FROM sistema.met_evaluacion ORDER BY codigo_metodo ASC ";
$resultado_qmevalua = pg_query($conexion, $query_mevalua);
$num1 = pg_num_rows($resultado_qmevalua);
...
?>
    ...
    <body>
        ...
        include("topbar.html"); ?>
        <!-- <div class="container mt-5 pt-3" style="margin-left: var(--sidebar-width); max-width:90%;"> -->
        <main id="content">
            <h4 class="text-center mt-2">CRUD - Tabla Metodologias de Evaluación</h4>


            <div class="row text-center" style="background-color: #cecece">
                <div class="col-md-6">
                    <strong>Registrar Nueva Metodología</strong>
                </div>
                <div class="col-md-6">
                    <strong>Lista de Metodología <span style="color: crimson"> ( <?php echo $num1; ?> )</span> </strong>
                </div>
            </div>
                                    ...
                                    <div class="col-md-12 p-2">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <?php
                                                    while ($dataMetodo = pg_fetch_array($resultado_qmevalua)) { ?>
                                                        <tr>
                                                            <td><?php echo $dataMetodo['codigo_metodo']; ?></td>
                                                            <td><?php echo $dataMetodo['nombre_metodo']; ?></td>



                                                            <td>
                                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteChildresn<?php echo $dataMetodo['codigo_metodo']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">
                                                                    <i data-feather="trash-2" width="20"></i>
                                                                </button>

                                                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editChildresn<?php echo $dataMetodo['codigo_metodo']; ?>" data-toggle="tooltip" data-placement="top" title="Modificar">
                                                        ...
                                                        <?php include('ModalEditarMetodo.php'); ?>

                                                        <!--Ventana Modal para la Alerta de Eliminar--->
                                                        <?php include('ModalEliminarMetodo.php'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.btnBorrar').click(function(e) {
                ...
                url = "recib_DeleteMetodo.php";
                $.ajax({
                    type: "POST",
                    url: url,
                    data: dataString,
                    success: function(data) {
                        window.location.href = "met_evaluacion.php";
                        $('#respuesta').html(data);
                    }
                });
                return false;
