...
if ($obj->codigo_programa <> "26" && $obj->codigo_programa <> "30" && $obj->codigo_programa <> "31" && $obj->codigo_programa <> "32") {
    ...
    if ($obj->s1_tiponovedad_p == " " || $obj->s1_tiponovedad_p == null) {
        $ylines3 = 0;
    }
    $pdf->SetXY(228, $y);
    ...
    $pdf->SetXY(251, $y);
    if ($obj->s1_estadoregistro_p == " " || $obj->s1_estadoregistro_p == null) {
        $pdf->MultiCell(15, 2, mb_convert_encoding("REGISTRO POR DEFINIR", 'ISO-8859-1'), 0, 'C', 0, 4);
    } else {
    ...
    if ($obj->s2_tiponovedad_p == " " || $obj->s2_tiponovedad_p == null) {
        $ylines3 = 0;
    }
    $pdf->SetXY(228, $y);
    ...
    $pdf->SetXY(251, $y);
    if ($obj->s2_estadoregistro_p == " " || $obj->s2_estadoregistro_p == null) {
        $pdf->MultiCell(15, 2, mb_convert_encoding("REGISTRO POR DEFINIR", 'ISO-8859-1'), 0, 'C', 0, 4);
    } else {
    ...
    if ($obj->s3_tiponovedad_p == " " || $obj->s3_tiponovedad_p == null) {
        $ylines3 = 0;
    }
    $pdf->SetXY(228, $y);
    ...
    $pdf->SetXY(251, $y);
    if ($obj->s3_estadoregistro_p == " " || $obj->s3_estadoregistro_p == null) {
        $pdf->MultiCell(15, 2, mb_convert_encoding("REGISTRO POR DEFINIR", 'ISO-8859-1'), 0, 'C', 0, 4);
    } else {
    ...
    if ($obj->s4_tiponovedad_p == " " || $obj->s4_tiponovedad_p == null) {
        $ylines3 = 0;
    }
    $pdf->SetXY(228, $y);
    ...
    $pdf->SetXY(251, $y);
    if ($obj->s4_estadoregistro_p == " " || $obj->s4_estadoregistro_p == null) {
        $pdf->MultiCell(15, 2, mb_convert_encoding("REGISTRO POR DEFINIR", 'ISO-8859-1'), 0, 'C', 0, 4);
    } else {
    ...
    if ($obj->s5_tiponovedad_p == " " || $obj->s5_tiponovedad_p == null) {
        $ylines3 = 0;
    }
    $pdf->SetXY(228, $y);
    ...
    $pdf->SetXY(251, $y);
    if ($obj->s5_estadoregistro_p == " " || $obj->s5_estadoregistro_p == null) {
        $pdf->MultiCell(15, 2, mb_convert_encoding("REGISTRO POR DEFINIR", 'ISO-8859-1'), 0, 'C', 0, 4);
    } else {
