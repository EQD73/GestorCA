...
while ($row = pg_fetch_assoc($resultado)) {
    ...
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(130, 7, mb_convert_encoding($row['nombre_asignatura'], 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(25, 7, mb_convert_encoding("Vigencia Año:", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 7, $row['ano_micro'], 1, 1, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(55, 7, "Facultad a la que tributa el Curso:", 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(105, 7, mb_convert_encoding($row['nombre_facultad'], 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(20, 7, "Semestre:", 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(20, 7, $row['semestre'], 1, 1, "C");
    $pdf->SetFont("Arial", "B", 9);
    $y = $pdf->GetY();
    $pdf->Cell(60, 15, "Programa a los que tributa el Curso:", 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(90, 5, mb_convert_encoding($row['nombre_programa'], 'ISO-8859-1'), 0, 'FJ', 0);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->SetXY(160, $y);
    $pdf->Cell(20, 5, mb_convert_encoding("Código:", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(30, 5, $row['codigo_asignaturacurso'], 1, 1, "C");
    $pdf->Cell(150);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(20, 5, mb_convert_encoding("Créditos:", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(30, 5, $row['creditos'], 1, 1, "C");
    $pdf->Cell(150);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(30, 5, mb_convert_encoding("Total Semanas:", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(20, 5, $row['total_semanas_periodo'], 1, 1, "C");
    // cargue de datos json requisitos
    if ($row['requisitos'] == '{}') {
        $text_array = '';
    } else {
        $array = $row['requisitos'];
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(200, 5, mb_convert_encoding($row['descripcion_intension'], 'ISO-8859-1'), 1, "J", false);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(200, 10, "2.2. Resultados de aprendizaje del programa a los que apunta la asignatura", 1, 1, "L", true);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(200, 5, mb_convert_encoding($row['resultados_aprendizaje'], 'ISO-8859-1'), 1, "J", false);
    ...
    $pdf->Cell(5);
    $pdf->Cell(80, 5, mb_convert_encoding($row['nombre_asignatura'], 'ISO-8859-1'), 0, 0, "L");
    ...
    $pdf->SetFont("Arial", "", 9);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->MultiCell(200, 5, mb_convert_encoding($row['estrategia_pyd'], 'ISO-8859-1'), 1, "J", false);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->Cell(200, 8, "2.3.2. Recursos", 1, 1, "L", true);
    $pdf->SetFont("Arial", "", 9);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->MultiCell(200, 5, mb_convert_encoding($row['recursos'], 'ISO-8859-1'), 1, "J", false);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    ...
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 8, mb_convert_encoding($row['u1_hp'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 8, mb_convert_encoding("Horas Independientes", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 8, mb_convert_encoding($row['u1_hi'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 8, mb_convert_encoding("Corte / Semanas", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 8, mb_convert_encoding($row['u1_cortesemanas'], 'ISO-8859-1'), 1, 1, "C");
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    ...
    $content1 = $row['u1_resultados'];
    $content2 = $row['u1_contenidos'];
    $content3 = $row['u1_actividades'];
    $content4 = $row['u1_evaluacion'];
    ...
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u2_hp'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 12, mb_convert_encoding("Horas Independientes", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u2_hi'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 12, mb_convert_encoding("Corte / Semanas", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u2_cortesemanas'], 'ISO-8859-1'), 1, 1, "C");
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 8, mb_convert_encoding("Resultados de aprendizaje de la asignatura", 'ISO-8859-1'), 1, 1, "L", true);

    // Contenido original con líneas en blanco
    $content1 = $row['u2_resultados'];
    $content2 = $row['u2_contenidos'];
    $content3 = $row['u2_actividades'];
    $content4 = $row['u2_evaluacion'];
    ...
    $pdf->Cell(50, 12, mb_convert_encoding("Horas Presenciales", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u3_hp'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 12, mb_convert_encoding("Horas Independientes", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u3_hi'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 12, mb_convert_encoding("Corte / Semanas", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u3_cortesemanas'], 'ISO-8859-1'), 1, 1, "C");
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 8, mb_convert_encoding("Resultados de aprendizaje de la asignatura", 'ISO-8859-1'), 1, 1, "L", true);
    // Contenido original con líneas en blanco
    $content1 = $row['u3_resultados'];
    $content2 = $row['u3_contenidos'];
    $content3 = $row['u3_actividades'];
    $content4 = $row['u3_evaluacion'];
    ...
    $pdf->Cell(50, 12, mb_convert_encoding("Horas Presenciales", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u4_hp'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 12, mb_convert_encoding("Horas Independientes", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u4_hi'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 12, mb_convert_encoding("Corte / Semanas", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u4_cortesemanas'], 'ISO-8859-1'), 1, 1, "C");
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 8, mb_convert_encoding("Resultados de aprendizaje de la asignatura", 'ISO-8859-1'), 1, 1, "L", true);

    // Contenido original con líneas en blanco
    $content1 = $row['u4_resultados'];
    $content2 = $row['u4_contenidos'];
    $content3 = $row['u4_actividades'];
    $content4 = $row['u4_evaluacion'];
    ...
    $pdf->Cell(50, 12, mb_convert_encoding("Horas Presenciales", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u5_hp'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 12, mb_convert_encoding("Horas Independientes", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u5_hi'], 'ISO-8859-1'), 1, 0, "C");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(50, 12, mb_convert_encoding("Corte / Semanas", 'ISO-8859-1'), 1, 0, "L");
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(15, 12, mb_convert_encoding($row['u5_cortesemanas'], 'ISO-8859-1'), 1, 1, "C");
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 8, mb_convert_encoding("Resultados de aprendizaje de la asignatura", 'ISO-8859-1'), 1, 1, "L", true);

    // Contenido original con líneas en blanco
    $content1 = $row['u5_resultados'];
    $content2 = $row['u5_contenidos'];
    $content3 = $row['u5_actividades'];
    $content4 = $row['u5_evaluacion'];
    ...
    $pdf->SetFont("Arial", "", 9);
    $pdf->Cell(260, 20, mb_convert_encoding($row['nombre_proyecto'], 'ISO-8859-1'), 1, 1, "J");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 6, mb_convert_encoding("Objetivo General del proyecto", 'ISO-8859-1'), 1, 1, "L", true);
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(260, 5, mb_convert_encoding($row['proy_asignaturas'], 'ISO-8859-1'), 1, "J");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 6, mb_convert_encoding("Objetivos especificos del proyecto:", 'ISO-8859-1'), 1, 1, "L", true);
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(260, 5, mb_convert_encoding($row['proy_tematicas'], 'ISO-8859-1'), 1, "J");
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 6, mb_convert_encoding("Resultados esperados del proyecto:", 'ISO-8859-1'), 1, 1, "L", true);
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(260, 5, mb_convert_encoding($row['proy_acciones'], 'ISO-8859-1'), 1, "J");
    $pdf->SetFont("Arial", "", 6);
    $pdf->Cell(25, 5, mb_convert_encoding("Fecha y Hora de impresión", 'ISO-8859-1'), 0, 0, "L");
    $pdf->Cell(5);
    $pdf->Cell(10, 5, date('d/m/Y'), 0, 0, 'L');
    ...
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(260, 5, mb_convert_encoding($row['ref_biblio'], 'ISO-8859-1'), 1, "J");
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 7, mb_convert_encoding("5.2. Otra bibliografía", 'ISO-8859-1'), 1, 1, "L", true);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(260, 5, mb_convert_encoding($row['ref_otra'], 'ISO-8859-1'), 1, "J");
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 7, mb_convert_encoding("5.3. Referencias en inglés", 'ISO-8859-1'), 1, 1, "L", true);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(260, 5, mb_convert_encoding($row['ref_ingles'], 'ISO-8859-1'), 1, "J");
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "B", 9);
    $pdf->Cell(260, 7, mb_convert_encoding("5.4. Webgrafía y bases de datos", 'ISO-8859-1'), 1, 1, "L", true);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->SetFont("Arial", "", 9);
    $pdf->MultiCell(260, 5, mb_convert_encoding($row['ref_webgrafia'], 'ISO-8859-1'), 1, "J");
    $pdf->SetFont("Arial", "", 6);
    //validacion
    $pdf->SetFillColor(181, 178, 178);
    $pdf->SetTextColor(0, 0, 0);
    ...
    $pdf->Ln(16);
    $pdf->Cell(85, 3, mb_convert_encoding($row['nombre_docente'], 'ISO-8859-1'), 0, 0, "C");
    $pdf->Cell(90, 3, mb_convert_encoding($row['validador1'], 'ISO-8859-1'), 0, 0, "C");
    $pdf->Cell(85, 3, mb_convert_encoding($row['validador2'], 'ISO-8859-1'), 0, 1, "C");
    $pdf->SetFont("Arial", "", 5);
    $pdf->Cell(85, 2, mb_convert_encoding($row['nombre_programa'], 'ISO-8859-1'), 0, 0, "C");
    $pdf->Cell(90, 2, mb_convert_encoding("COORDINADOR " . $row['nombre_programa'], 'ISO-8859-1'), 0, 0, "C");
    ...
    $pdf->Cell(25, 5, date("d/m/Y", strtotime($row['fecha_actualizacion'])), 0, 0, "L");
    //mb_convert_encoding($row['fecha_actualizacion, 'ISO-8859-1'), 0, 0, "L");
    $pdf->Cell(0, 5, mb_convert_encoding('Página ', 'ISO-8859-1') . $pdf->PageNo() . '/{nb}', 0, 0, "R");
}

$pdf->Output('I', 'reporte_microcurriculo_.pdf');
