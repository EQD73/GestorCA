            ...
            <div class="container mt-5">
                ...
                <div class="card shadow">
                    <div class="card-header bg-danger text-white">
                        <!-- <h2 class="text-center mb-4">Reporte Diligenciamiento por Programa</h2> -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-3">
                                ...
                                <select id="selectAno" class="form-select select2" style="width: 100%">
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="selectPrograma" class="form-select select2" name="codigo_programa" style="width: 100%" onchange="setNombrePrograma()">
                                    <option value="">Todos</option>
                                    <?php
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="selectAsignatura" class="form-select select2" style="width: 100%">
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="selectSemestre" class="form-select select2" style="width: 100%">
                                    <option value="">Todos</option>
                                    <?php
                        ...
                        <h4 class="mt-4">Diligenciamiento de Microcurriculo</h4>
                        <table class="table table-bordered">
                            ...
                            <tbody id="tabla-datos">
                                <!-- <tr>
                                    <td colspan="7" class="text-center">Seleccione año para ver los datos</td>
                                </tr> -->
                            </tbody>
                        </table>
                    </div>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $("#filtrar-btn").click(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                //console.log("Datos recibidos:", response); // ← Añade esto
                                let tablaHtml = "";
                                let labels = [];
                                let data = [];
                    ...
                    $("#exportExcel").click(function() {
                        ...
                        let semestre = $("#selectSemestre").val();
                        let nombrePrograma = $("#nombre_programa").val();
                        window.location.href = "export_excel_micro_r1.php?ano=" + ano + "&programa=" + programa + "&asignatura=" + asignatura + "&semestre=" + semestre + "&nombrePrograma=" + nombrePrograma; // Redirige a exportar_excel.php
                    });
                });
            </script>
