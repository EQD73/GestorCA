        ...
        <div id="app">
            ...
            <div id="main">
                ...
                <div class="container mt-5">
                    <h1 class="text-center">Cargar archivo Usuarios.CSV</h1>

                    <!-- Enlace de descarga con una imagen -->
                    <div class="text-center">
                        <a href="descargar1.php" class="btn btn-success">
                    ...
                    <?php if (isset($_GET['status'])): ?>
                        ...
                        <?php elseif ($_GET['status'] == 'error_file'): ?>
                            <div class="alert alert-danger" role="alert">
                                Hubo un problema al subir el archivo. Falla de conexion a BD o Usuarios Duplicados. Por favor valide logs de cargue/duplicados, intente de nuevo.
                            </div>
            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    if (response.status === 'duplicados') {
                        ...
                        window.location.href = 'cargue1.php?status=error_file';
                    } else if (response.status === 'success') {
                        // Mostrar mensaje de éxito si no hay duplicados
                        alert(response.message);
                        window.location.href = 'cargue1.php?status=success';
                    }
