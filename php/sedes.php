...
$resultado_qsedes = pg_query($conexion, $query_sedes);
$num1 = pg_num_rows($resultado_qsedes);
?>
...
?>
    ...
    <body>
        ...
        <main id="content">
            <h4 class="text-center mt-2">CRUD - Tabla de Sedes</h4>
            <div class="row text-center" style="background-color: #cecece">
                <div class="col-md-6">
                    <strong>Registrar Nueva Sede</strong>
                </div>
                <div class="col-md-6">
                    <strong>Lista de Sedes<span style="color: crimson"> ( <?php echo $num1; ?> )</span> </strong>
                </div>
            </div>
                                            ...
                                            <table class="table table-bordered table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="color:black" style="width:30px" scope="col">Acción</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    while ($dataSede = pg_fetch_array($resultado_qsedes)) { ?>
                                                        <tr>
                                                            <td><?php echo $dataSede['codigo_sede']; ?></td>
                                                            <td><?php echo $dataSede['nombre_sede']; ?></td>


                                                            <td>
                                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteChildresn<?php echo $dataSede['codigo_sede']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">
                                                                    <i data-feather="trash-2" width="20"></i>
                                                                </button>

                                                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editChildresn<?php echo $dataSede['codigo_sede']; ?>" data-toggle="tooltip" data-placement="top" title="Modificar">
                                                        ...
                                                        <?php include('ModalEditarSede.php'); ?>

                                                        <!--Ventana Modal para la Alerta de Eliminar--->
                                                        <?php include('ModalEliminarSede.php'); ?>
