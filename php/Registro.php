    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '.regular', function() {
                ...
                if (id_registro) {
                window.location.href = "editar_regularRegistro.php?id=" + id_registro;
                }
            });
            ...
            $(document).on('click', '.mregular', function() {
                ...
                if (id_registro) {
                window.location.href = "modificar_regularRegistro.php?id=" + id_registro;
                }
            });
            ...
            $(document).on('click', '.novedad', function() {
                ...
                if (id_registro) {
                window.location.href = "editar_novedadRegistro.php?id=" + id_registro ;
                }
            });
            ...
            $(document).on('click', '.mnovedad', function() {
                ...
                if (id_registro) {
                window.location.href = "modificar_novedadRegistro.php?id=" + id_registro;
                }
            });
